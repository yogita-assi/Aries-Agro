...
import { orderOtpStyle } from "../../../shared/styles/orderOtpStyle";
...
const OrderVerificationScreen = ({ route: { params }, route }: any) => {
    ...
    return (
        <SafeAreaView style={orderOtpStyle.dashboardContainer}>
            ...
            <KeyboardAwareScrollView keyboardShouldPersistTaps="handled" style={orderOtpStyle.mainParent}>
                <View style={orderOtpStyle.contentHeaderWrapper}>
                    <TextArchivoBold style={orderOtpStyle.textEnterOtp}>Enter OTP</TextArchivoBold>
                    <View style={orderOtpStyle.verifyInput}>
                        <CodeField
                            ref={ref}
                            {...props}
                            value={value}
                            ...
                            renderCell={({ index, symbol, isFocused }) => (
                                <View style={orderOtpStyle.otpBoxes} key={index}>
                                    <CustomFontText
                                        style={orderOtpStyle.inputStyle}
                        ...
                        />
                        <View style={orderOtpStyle.otpFormTxt}>
                            <Text style={orderOtpStyle.otpErroFormTxt}>{errorMsg}</Text>
                        </View>
                    </View>
                    <View style={orderOtpStyle.countDown}>
                        <CountDown
                    ...
                    {sessionTimeOut && <View style={orderOtpStyle.resOtp}>
                        <TextArchivoBold style={orderOtpStyle.resendOTPTxt}>Didn't receive OTP?</TextArchivoBold>
                        <Pressable onPress={() => onResendOTP()}>
                            <TextArchivoBold style={orderOtpStyle.resendOTP}>Resend</TextArchivoBold>
                        </Pressable>
                    </View>
                    }
                </View>
            </KeyboardAwareScrollView>
            <CustomButton label={"Confirm Or Upload Order"} onPress={() => onVerifyOTP()} isLoader={isLoader} />
        </SafeAreaView>
    )
}
